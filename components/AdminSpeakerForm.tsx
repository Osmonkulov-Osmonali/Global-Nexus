...
interface AdminSpeakerFormProps {
  onAdd: (input: AdminSpeakerInput) => void;
}
...
export default function AdminSpeakerForm({ onAdd }: AdminSpeakerFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="glass rounded-2xl p-6">
      ...
      <button
        type="submit"
        className="mt-5 inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 px-5 py-2.5 text-sm font-medium text-white transition hover:opacity-90"
      >
