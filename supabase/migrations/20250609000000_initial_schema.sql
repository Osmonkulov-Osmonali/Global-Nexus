-- Global Nexus: speakers + speaker applications
...
create policy "Authenticated users can delete applications"
  on public.speaker_applications for delete
  to authenticated
  using (true);

-- Seed demo speakers (skip if table already has rows)
...
-- Realtime for live counter + wall updates
